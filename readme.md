# <font color=purple> Выпускной проект по DS и ML на Яндекс.Практикуме Выпускной проект </font>
...
***Задача:***<br/>
Спрогнозировать температуру сплава в конце процесса обработки стали (задача регресии).
